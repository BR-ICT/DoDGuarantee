...
import static com.br.utility.Constant.Teststatus;
...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String strteststatus = new String("teststatus");
...
//                    System.out.println("User:" + username + "\n" + "Pass:" + password + "\n" + "Auth:" + checkAuth.toString());
                    ...
                    response.sendRedirect("./?page=menu");
                    
                    if(Teststatus.equals("test")){
                        session.setAttribute(strteststatus, "test");
                    }
                    else {
                        session.setAttribute(strteststatus, "");
                    }
