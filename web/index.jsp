...
<html>
    ...
    <head>
        ...
        <title>DoDGuarantee : <%out.print(session.getAttribute("comp"));%></title> 
    </head>
    ...
    <body style="background-color: #bababa;">
        ...
        <div>
            <nav id="vNavbar" class="navbar navbar-default navigation-clean" >
                <div class="container">
                    <div class="navbar-header"><a class="navbar-brand" href="./?page=menu">DOD DEPOSIT SYSTEM</a><button data-toggle="collapse" class="navbar-toggle collapsed" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div>
                    <div class="navbar-header"><a class="navbar-brand" href="./?page=menu" id="teststatus"></a><button data-toggle="collapse" class="navbar-toggle collapsed" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" href="?page=menu">Menu</a></li>
                            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" href="?page=master">Master</a></li>
                            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" href="?page=createDoD">Create DOD</a></li>
                            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" href="?page=closeDoD">Close DOD</a></li>
                            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" href="?page=print">Print</a></li>
...
//    }
    var testornot = "<%out.print(session.getAttribute("teststatus"));%>";
    $("#teststatus").text(testornot);
//    console.log(testornot);
//    else if (datatype === 2) {
